...
def search(request):
    ...
    if form.is_valid():
        ...
        results = []
    return render(request, 'home/search_results.html', {'searchForm': form, 'searchResults': results})
...
def category_projects(request, category_id):
    try:
        ...
        return render(request, 'home/category_projects.html', {'category_projects': category_projects, 'selected_category':selected_category})
...
def category_detail(request, category_id):
    try:
        ...
        return render(request, 'home/category_detail.html', {'category': category, 'projects': projects})
    except Exception as e:
        return render(request,'404.html')