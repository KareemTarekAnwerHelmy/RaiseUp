...
from projects.forms import Project_ModelForm,ProjectReport_ModelForm
from django.contrib.auth.decorators import login_required
from projects.models import Donation, Project,Picture,Tag,Comment,Rate,Comment,Project_Report,Comment_Report
...
def createProject(request):
    ...
    return render(request, 'projects/create-project.html', context={"form":form})
...
def create_comment(request, project_id):
    try:
        ...
        return render(request, "projects/project_details.html", context={"user": user, "project": project})
    except Exception as e:
        return render(request, "404.html")
                ...
                if donationAmount:
                    if donationAmount.strip():
                        ...
                        if donationAmount + project.current_donation > project.total_target:
                            ...
                            project.save()
                return redirect('project_details', project_id)
        return render(request, "projects/project_details.html", context={"user": user, "project": project,"error_message": error_message})
    except Exception as e:
        return render(request, "404.html")
